...
function updateValue(e) {
  selectedCards.value.find((v) => v == e)
    ? (selectedCards.value = selectedCards.value.filter((n) => n != e))
    : selectedCards.value.push(+e);
}
</script>
  ...
  <div class="shadow-lg p-5 bg-white rounded-lg">
    <div>
      ...
      <div :key="q_data[index].id">
        <p class="text-center text-bv-green font-bold">
          Question
