      ...
      <article class="grid grid-cols-12 gap-5 pr-44 pl-44 pt-32">
        <h2 class="col-span-full border-l-bv-green border-l-8  pl-2">À ne pas louper</h2>
          ...
          <div class="relative flex flex-col gap-3 col-span-4 bg-slate-200 p-5 pt-[109px] mt-12 rounded-md">
            ...
            <div class="flex w-fit p-2  pl-3 pr-3 bg-bv-purple rounded-[40px] text-white ">
              Quizz
            </div>
        ...
        <!-- ===== Bien viellir a ma manière ==== -->
         <div class="col-span-full flex flex-grow p-44 pt-16 pb-20  gap-14 h-[355px] bg-bv-blue-bg">
            <div class="relative h-full w-[153px]}">
              <img class=" absolute top-0" src="@/assets/images/ppl-computing.png" alt="">
              <img class="absolute -top-8 left-40" src="@/assets/images/sun.png" alt="">
            </div>
            <div >
              <h2 class="text-bv-purple">Bien vieillir à ma manière !</h2>
              <p class="text-bv-grey-2 mt-5  ">Je réponds à un court questionnaire <br/>  et je découvre les articles, conseils et activités qui me correspondent !
</p>
<button class="bg-bv-purple text-white rounded-xl p-8 pt-4 pb-4 mt-8">J'y vais !</button>
            </div>
         </div>
